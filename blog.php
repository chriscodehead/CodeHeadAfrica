                                            ...
                                            <div class="col-lg-6">
                                                <div class="cont">
                                                    <small class="date small mb-20"> <a href="#"
                                                        ...
                                                        </a> <i class="far fa-clock me-1"></i> Posted on <a href="#">3
                                                            Days ago</a> </small>
                                                    <h2 class="title">
                                                        <a href="blog-page">Solutions For Big Data Issue,
                                                            Expert Perspective</a>
                                                    </h2>
                                                    <p class="fs-13px mt-10 text-light text-info">If there’s one way
                                                        that wireless technology has changed the way we work, it’s that
                                                        will everyone is now connected [...]</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            ...
                            <div class="card-body px-0">
                                ...
                                <h5 class="fw-bold mt-10 title">
                                    <a href="blog-page">Crypto Trend 2023</a>
                                </h5>
                    ...
                    <div class="col-lg-4 border-end brd-gray">
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            ...
                            <div class="card-body px-0">
                                ...
                                <h5 class="fw-bold mt-10 title">
                                    <a href="blog-page">AI With Fingerprint</a>
                                </h5>
                                <p class="small mt-2 op-8 fs-10px">If there’s one way that wireless technology has
                                    changed the way we work, it’s that will everyone is now connected [...]
                                </p>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            ...
                            <div class="card-body px-0">
                                ...
                                <h5 class="fw-bold mt-10 title">
                                    <a href="blog-page">NFT Game! New Oppoturnity</a>
                                </h5>
                                <p class="small mt-2 op-8 fs-10px">If there’s one way that wireless technology has
                                    changed the way we work, it’s that will everyone is now connected [...]
                                </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">How To Become A
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">VR Game, Oppoturnity
                                            & Challenge</a>
                                        <p class="fs-13px color-666">If there’s one way that wireless technology has
                                            changed the way we work, it’s that will everyone [...]</p>
                                        <div
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">6 Tips To Help You
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">The New Trend Of
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">Workflow Strategy For
                                            E-Shop</a>
                                        <p class="fs-13px color-666">If there’s one way that wireless technology has
                                            changed the way we work, it’s that will everyone [...]</p>
                                        <div
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">Wireframe For
                                            UI/UX</a>
                                        <p class="fs-13px color-666">If there’s one way that wireless technology has
                                            changed the way we work, it’s that will everyone [...]</p>
                                        <div
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                                        ...
                                        <a href="blog-page" class="card-title mb-10">Freelancer Days 2022,
                                            What’s new?</a>
                                        <p class="fs-13px color-666">If there’s one way that wireless technology has
                                            changed the way we work, it’s that will everyone [...]</p>
                                        <div
                    ...
                    <div class="col-lg-4">
                        <div class="side-blog style-5 ps-lg-5 mt-5 mt-lg-0">
                            ...
                            <div class="side-recent-post mb-50">
                                ...
                                <a href="blog-page" class="post-card pb-3 mb-3 border-bottom brd-gray">
                                    <div class="img me-3">
                                        <img src="assets/img/blog/1.jpg" alt="">
                                    </div>
                                    <div class="inf">
                                ...
                                <a href="blog-page" class="post-card">
                                    <div class="img me-3">
